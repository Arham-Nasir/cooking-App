...
public class DownloadAdapter extends RecyclerView.Adapter<DownloadAdapter.MyViewHolder> {
    ...
    public DownloadAdapter(List<DishesData> ls, Context c) {
        this.ls = ls;
        this.c = c;
    }
    ...
    public DownloadAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View row= LayoutInflater.from(c).inflate(R.layout.downdishes,parent,false);
    ...
    public void onBindViewHolder(@NonNull DownloadAdapter.MyViewHolder holder, int position) {
        ...
        holder.Downrv.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        RelativeLayout Downrv;
        ImageView image;
        TextView name,author,time,difficulty;
        public MyViewHolder(@NonNull View itemView){
            super(itemView);
            Downrv = itemView.findViewById(R.id.categoryID);
