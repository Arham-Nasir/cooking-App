...
public class Favourite extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        menu_button = view.findViewById(R.id.menu_icon_fav);
        drawerLayout = view.findViewById(R.id.drawer_fav);
        navigationView = view.findViewById(R.id.nav_fav);
        ...
        Profile_photo = view.findViewById(R.id.profilepic_fav);
...
//                .show();
        ...
        favAdapter = new FavAdapter(favlist, getActivity());
    ...
    private void show_favourite_dishes() {
        ...
        DatabaseReference Fav = FavDish.getReference("User_info").child(UserID).child("Favourite_Dishes");
...
//                                                    Toast.makeText(getActivity(),favID,Toast.LENGTH_LONG).show();
                                                    ...
                                                    favlist.add(new DishesData(User_id,Id,image,name,author,time,difficulty,category,serving));
